...
public class ScansToDoListIterator implements Iterator<Task>{
    ...
    public ScansToDoListIterator(ToDoList toDoList, Date date) {
    ...
    public boolean hasNext() {
        if (this.date==null) {
            return this.currentIndex < this.size;
                ...
                .compareTo(this.sortedTasksList.get(currentIndex).getDueDate()) < 0;
    }
